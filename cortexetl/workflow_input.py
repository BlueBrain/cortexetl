...
def extract_fr_df(a):
    ...
    fr_df = a.custom['by_neuron_class'].etl.q(neuron_class=c_etl.LAYER_EI_NEURON_CLASSES, window=a.analysis_config.custom['fr_df_windows']).drop(['simulation_id'], axis=1)
